...
//  TwitterClone
//
//  Created by Md Shohidur Rahman on 5/28/23.
//
...
class LoginViewController: UIViewController {
    ...
    private var vm = AuthenticationViewViewModel()
    ...
    private func bindViews(){
        ...
        vm.$isAuthenticationFormValid.sink{[weak self] validationState in
        ...
        vm.$error.sink { [weak self] errorString in
